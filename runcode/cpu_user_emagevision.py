...
# read file
file = open('../emagevision/output_show_user_mem_usage.log', 'r')
lines = file.read().splitlines()
file.close()

# write to excel
import xlsxwriter
workbook = xlsxwriter.Workbook('../emagevision/cpu_each_user_emagevision.xlsx')
...
count_mem = 0
count_used = 0
# _list_user = ['bhabani', 'biju', 'dustin', 'gowtham', 'nithin', 'pravin', 'root', 'shivaraj', 'shreevijay', 'suraj', 'thinh', 'udupa', 'vignesh', 'wong']
_list_user = _get_list_user_func("Userlist/EV-Linux.log")
_count_user = 0
